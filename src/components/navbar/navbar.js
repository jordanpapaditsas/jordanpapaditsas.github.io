  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-hamburger-menu" style={{ display: showMenu ? 'flex': 'none' }}>
        <Link activeClass="active" to="home" spy={true} smooth={true} offset={-100} duration={500} className="ham-list-item" onClick={()=>setShowMenu(false)}>Home</Link>
        <Link activeClass="active" to="projects" spy={true} smooth={true} offset={-100} duration={500} className="ham-list-item" onClick={()=>setShowMenu(false)}>Projects</Link>
